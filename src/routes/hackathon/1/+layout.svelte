<script>
    ...
    const base = '/hackathon/1';

    const tabs = [
        { label: 'Main', href: base },
...
<div
    ...
    style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), no-repeat center / cover url('/gijang.jpg');"
>
...
<div class="bg-white border-b">
    <div class="container mx-auto">
        <nav class="flex space-x-1 px-8">
            {#each tabs as tab}
                <a
                    href={tab.href}
                    class="px-5 py-3 font-medium text-lg border-b-2 transition-colors
