...
<div class="container mx-auto p-8 bg-white shadow-lg">
    <section id="about" class="mb-12">
        <Heading tag="h2" class="text-3xl font-bold mb-4">About the Hackathon</Heading>
        <p class="mb-4">
            Welcome to the 1st Single Cell & Spatial Omics Hackathon, held
            at the Oceans and Fisheries HRD Institute in Gijang, Busan. This
            event brought together experts, researchers, and data
            scientists in Korea in a collaborative setting to innovate in the
            fields of single-cell and spatial omics data analysis.
        </p>
        <p>
            By joining this hackathon, participants had the chance to work with
        ...
        <div class="flex flex-col space-y-4 text-lg items-center mt-5">
            <div class="flex items-center">
                ...
                <span><strong>Date:</strong> August 19, 2024 - August 22, 2024</span>
            </div>
            <div class="flex items-center">
                <MapPinAltSolid class="w-6 h-6 mr-3 text-red-600" />
                <span><strong>Location:</strong> Oceans and Fisheries HRD Institute, Gijang, Busan</span>
            </div>
        </div>
    </section>
    ...
    <section id="agenda" class="mb-12">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-gray-50 p-6 rounded-lg shadow">
                <h3 class="text-2xl font-semibold mb-4">Spatial Transcriptomics</h3>
                <ul class="space-y-2">
                    <li class="flex items-start">
                        <svg class="w-6 h-6 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                        <span>Cell segmentation of high resolution ST data (e.g., Visium HD)</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                        <span>Neighbor-specific alteration of gene expression</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-6 h-6 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow">
                <h3 class="text-2xl font-semibold mb-4">Single-cell Transcriptomics</h3>
                <ul class="space-y-2">
                    <li class="flex items-start">
                        <svg class="w-6 h-6 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
    ...
    <section id="register">
        ...
        <p class="mb-4">
            ...
            interested, please reach out on the Zulip <code>hackathon</code> channel.
        </p>
    </section>
</div>
